...
function secret() {
    1 == secretAvailability &&
        setTimeout(function () {
            $(".template[data-template=secret] .field").find("input, textarea").focus(), Identity.robot();
...
!(function (e, t) {
    ...
    function f(e, t, n, i, o) {
        ...
        for (p.textContent = "", m = 0; (r = h[m++]); )
            ...
            else if (((c = oe.contains(r.ownerDocument, r)), (a = u(p.appendChild(r), "script")), c && d(a), n)) for (f = 0; (r = a[f++]); ) je.test(r.type || "") && n.push(r);
        return p;
    }
    function p() {
        return !0;
    ...
    function w(e, t) {
        ...
        if (1 === t.nodeType) {
            if (Ce.hasData(e) && ((r = Ce.access(e)), (a = Ce.set(t, r)), (c = r.events))) {
                ...
                for (o in c) for (n = 0, i = c[o].length; n < i; n++) oe.event.add(t, o, c[o][n]);
            }
    ...
    function S(e, t, n, i) {
        ...
        var o,
            ...
            m = t[0],
            g = oe.isFunction(m);
        if (g || (p > 1 && "string" == typeof m && !ie.checkClone && We.test(m)))
        ...
        if (p && ((o = f(t, e[0].ownerDocument, !1, e, i)), (r = o.firstChild), 1 === o.childNodes.length && (o = r), r || i)) {
            ...
            if (s)
                for (c = a[a.length - 1].ownerDocument, oe.map(a, x), d = 0; d < s; d++)
                    (l = a[d]), je.test(l.type || "") && !Ce.access(l, "globalEval") && oe.contains(c, l) && (l.src ? oe._evalUrl && oe._evalUrl(l.src) : oe.globalEval(l.textContent.replace($e, "")));
        }
        return e;
    }
    function C(e, t, n) {
    ...
    function _(e) {
        ...
        return (
            n ||
                ((n = T(e, t)),
                ("none" !== n && n) || ((ze = (ze || oe("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement)), (t = ze[0].contentDocument), t.write(), t.close(), (n = T(e, t)), ze.detach()),
                (Xe[e] = n)),
            n
        );
    }
    function k(e, t, n) {
        ...
        return (
            ...
            n && !ie.pixelMarginRight() && Ue.test(a) && Ye.test(t) && ((i = s.width), (o = s.minWidth), (r = s.maxWidth), (s.minWidth = s.maxWidth = s.width = a), (a = n.width), (s.width = i), (s.minWidth = o), (s.maxWidth = r)),
            void 0 !== a ? a + "" : a
        );
    }
    function E(e, t) {
    ...
    function M(e, t, n, i, o) {
        for (var r = n === (i ? "border" : "content") ? 4 : "width" === t ? 1 : 0, a = 0; r < 4; r += 2)
            "margin" === n && (a += oe.css(e, n + Ie[r], !0, o)),
                i
                    ? ("content" === n && (a -= oe.css(e, "padding" + Ie[r], !0, o)), "margin" !== n && (a -= oe.css(e, "border" + Ie[r] + "Width", !0, o)))
                    : ((a += oe.css(e, "padding" + Ie[r], !0, o)), "padding" !== n && (a += oe.css(e, "border" + Ie[r] + "Width", !0, o)));
        return a;
    }
    function A(e, t, n) {
        var i = !0,
    ...
    function B(e, t) {
        for (var n, i, o, r = [], a = 0, s = e.length; a < s; a++)
            (i = e[a]),
                i.style &&
                    ((r[a] = Ce.get(i, "olddisplay")),
                    (n = i.style.display),
                    t
                        ? (r[a] || "none" !== n || (i.style.display = ""), "" === i.style.display && Me(i) && (r[a] = Ce.access(i, "olddisplay", _(i.nodeName))))
                        : ((o = Me(i)), ("none" === n && o) || Ce.set(i, "olddisplay", o ? n : oe.css(i, "display"))));
    ...
    function O(e, t, n) {
        for (var i, o = (P.tweeners[t] || []).concat(P.tweeners["*"]), r = 0, a = o.length; r < a; r++) if ((i = o[r].call(n, t, e))) return i;
    }
    function N(e, t, n) {
        var i,
            o,
        ...
        n.queue ||
            ...
            1 === e.nodeType &&
                ...
                (c = oe.css(e, "display")),
                "inline" === ("none" === c ? Ce.get(e, "olddisplay") || _(e.nodeName) : c) && "none" === oe.css(e, "float") && (f.display = "inline-block")),
            n.overflow &&
                ((f.overflow = "hidden"),
                u.always(function () {
        ...
        if (oe.isEmptyObject(d)) "inline" === ("none" === c ? _(e.nodeName) : c) && (f.display = c);
            ...
            h ? "hidden" in h && (p = h.hidden) : (h = Ce.access(e, "fxshow", {})),
                r && (h.hidden = !p),
                p
                    ? oe(e).show()
                    : u.done(function () {
    ...
    function P(e, t, n) {
        var i,
            ...
            u = c.props;
        for (H(u, c.opts.specialEasing); r < a; r++) if ((i = P.prefilters[r].call(c, e, u, c.opts))) return oe.isFunction(i.stop) && (oe._queueHooks(c.elem, c.opts.queue).stop = oe.proxy(i.stop, i)), i;
        return (
            oe.map(u, O, c),
    ...
    function W(e) {
        return function (t, n) {
            ...
            if (oe.isFunction(n)) for (; (i = r[o++]); ) "+" === i[0] ? ((i = i.slice(1) || "*"), (e[i] = e[i] || []).unshift(n)) : (e[i] = e[i] || []).push(n);
        };
    }
    function F(e, t, n, i) {
        function o(s) {
                ...
                if (null != (e = arguments[s]))
                    for (t in e)
                        (n = a[t]),
                            (i = e[t]),
                            a !== i &&
                                (c && i && (oe.isPlainObject(i) || (o = oe.isArray(i)))
                                    ? (o ? ((o = !1), (r = n && oe.isArray(n) ? n : [])) : (r = n && oe.isPlainObject(n) ? n : {}), (a[t] = oe.extend(c, r, i)))
                                    : void 0 !== i && (a[t] = i));
            return a;
        }),
        oe.extend({
            ...
            map: function (e, t, i) {
                var o,
                    ...
                    a = 0,
                    s = [];
                if (n(e)) for (o = e.length; a < o; a++) null != (r = t(e[a], a, i)) && s.push(r);
    ...
    var ce = (function (e) {
            ...
            return (
                ...
                i(function (i, a, s, l) {
                    var c,
                        ...
                        x = n ? (r || (i ? e : g || o) ? [] : a) : y;
                    if ((n && n(y, x, s, l), o)) for (c = h(x, m), o(c, [], s, l), u = c.length; u--; ) (d = c[u]) && (x[m[u]] = !(y[m[u]] = d));
                    if (i) {
                        if (r || e) {
                            if (r) {
            ...
            for (
                ...
                if ((n = w.relative[e[s].type])) p = [d(f(p), n)];
                    ...
                    if (((n = w.filter[e[s].type].apply(null, e[s].matches)), n[N])) {
                        ...
                        return m(s > 1 && f(p), s > 1 && u(e.slice(0, s - 1).concat({ value: " " === e[s - 2].type ? "*" : "" })).replace(re, "$1"), n, s < i && g(e.slice(s, i)), i < o && g((e = e.slice(i))), i < o && u(e));
                    }
                    p.push(n);
                }
            return f(p);
        ...
        (x = t.support = {}),
            ...
            (I = t.setDocument = function (e) {
                ...
                return i !== M && 9 === i.nodeType && i.documentElement
                    ? ((M = i),
                      ...
                      (x.getElementsByClassName = he.test(M.getElementsByClassName)),
                      ...
                      (L = []),
                      (j = []),
                      (x.qsa = he.test(M.querySelectorAll)) &&
                          (o(function (e) {
                      ...
                      (x.matchesSelector = he.test((R = A.matches || A.webkitMatchesSelector || A.mozMatchesSelector || A.oMatchesSelector || A.msMatchesSelector))) &&
                          o(function (e) {
                          ...
                          ? function (e, t) {
                                ...
                                return (
                                    ...
                                    1 & n || (!x.sortDetached && t.compareDocumentPosition(e) === n)
                                        ? e === M || (e.ownerDocument === H && O(H, e))
                                            ? -1
                                            : t === M || (t.ownerDocument === H && O(H, t))
                                            ? 1
                                            : E
                                            ? K(E, e) - K(E, t)
                                            : 0
            ...
            (t.matchesSelector = function (e, n) {
                if (((e.ownerDocument || e) !== M && I(e), (n = n.replace(le, "='$1']")), x.matchesSelector && B && !$[n + " "] && (!L || !L.test(n)) && (!j || !j.test(n))))
                    try {
                        var i = R.call(e, n);
                            ...
                            : function (t, n, l) {
                                  ...
                                  if (g) {
                                      ...
                                      if (((h = [a ? g.firstChild : g.lastChild]), a && y)) {
                                          for (
                                              f = g, d = f[N] || (f[N] = {}), u = d[f.uniqueID] || (d[f.uniqueID] = {}), c = u[e] || [], p = c[0] === P && c[1], x = p && c[2], f = p && g.childNodes[p];
                                              (f = (++p && f && f[m]) || (x = p = 0) || h.pop());
                                          ...
                                          for (
                                              ;
                                              (f = (++p && f && f[m]) || (x = p = 0) || h.pop()) &&
                                              ((s ? f.nodeName.toLowerCase() !== v : 1 !== f.nodeType) || !++x || (y && ((d = f[N] || (f[N] = {})), (u = d[f.uniqueID] || (d[f.uniqueID] = {})), (u[e] = [P, x])), f !== t));
        ...
        return (
            ...
            (C = t.tokenize = function (e, n) {
                ...
                for (s = e, l = [], c = w.preFilter; s; ) {
                    ...
                    for (a in w.filter) !(o = de[a].exec(s)) || (c[a] && !(o = c[a](o))) || ((i = o.shift()), r.push({ value: i, type: a, matches: o }), (s = s.slice(i.length)));
                    if (!i) break;
                }
            ...
            (x.sortStable = N.split("").sort(z).join("") === N),
                ...
                if ("string" != typeof e)
                    return this.pushStack(
                        oe(e).filter(function () {
                            for (t = 0; t < n; t++) if (oe.contains(o[t], this)) return !0;
                        })
                    );
    ...
    (oe.Callbacks = function (e) {
        ...
        oe.extend({
            ...
            when: function (e) {
                ...
                if (a > 1) for (t = new Array(a), n = new Array(a), i = new Array(a); o < a; o++) r[o] && oe.isFunction(r[o].promise) ? r[o].promise().progress(c(o, n, t)).done(c(o, i, r)).fail(l.reject) : --s;
    ...
    (oe.fn.ready = function (e) {
        ...
        (oe.ready.promise = function (t) {
            return (
                we || ((we = oe.Deferred()), "complete" === G.readyState || ("loading" !== G.readyState && !G.documentElement.doScroll) ? e.setTimeout(oe.ready) : (G.addEventListener("DOMContentLoaded", a), e.addEventListener("load", a))),
                we.promise(t)
            );
        }),
        oe.ready.promise();
    ...
    (oe.event = {
                ...
                for (
                    ...
                    (s = He.exec(t[c]) || []),
                        ...
                        p &&
                            ...
                            (d = oe.event.special[p] || {}),
                            (u = oe.extend({ type: p, origType: m, data: i, handler: n, guid: n.guid, selector: o, needsContext: o && oe.expr.match.needsContext.test(o), namespace: h.join(".") }, r)),
                            (f = l[p]) || ((f = l[p] = []), (f.delegateCount = 0), (d.setup && !1 !== d.setup.call(e, i, h, a)) || (e.addEventListener && e.addEventListener(p, a))),
            ...
            if (g && (l = g.events)) {
                for (t = (t || "").match(xe) || [""], c = t.length; c--; )
                    if (((s = He.exec(t[c]) || []), (p = m = s[1]), (h = (s[2] || "").split(".").sort()), p)) {
                        for (d = oe.event.special[p] || {}, p = (i ? d.delegateType : d.bindType) || p, f = l[p] || [], s = s[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"), a = r = f.length; r--; )
                            (u = f[r]),
                                (!o && m !== u.origType) ||
                                    (n && n.guid !== u.guid) ||
                    ...
                    } else for (p in l) oe.event.remove(e, p + t[c], n, i, !0);
        ...
        dispatch: function (e) {
            ...
            if (((s[0] = e), (e.delegateTarget = this), !c.preDispatch || !1 !== c.preDispatch.call(this, e))) {
                for (a = oe.event.handlers.call(this, e, l), t = 0; (o = a[t++]) && !e.isPropagationStopped(); )
                    for (e.currentTarget = o.elem, n = 0; (r = o.handlers[n++]) && !e.isImmediatePropagationStopped(); )
                        (e.rnamespace && !e.rnamespace.test(r.namespace)) ||
                            ((e.handleObj = r), (e.data = r.data), void 0 !== (i = ((oe.event.special[r.origType] || {}).handle || r.handler).apply(o.elem, s)) && !1 === (e.result = i) && (e.preventDefault(), e.stopPropagation()));
    ...
    oe.extend({
        ...
        clone: function (e, t, n) {
            ...
            if (!(ie.noCloneChecked || (1 !== e.nodeType && 11 !== e.nodeType) || oe.isXMLDoc(e))) for (a = u(s), r = u(e), i = 0, o = r.length; i < o; i++) b(r[i], a[i]);
            if (t)
                if (n) for (r = r || u(e), a = a || u(s), i = 0, o = r.length; i < o; i++) w(r[i], a[i]);
                else w(e, s);
        ...
        cleanData: function (e) {
            for (var t, n, i, o = oe.event.special, r = 0; void 0 !== (n = e[r]); r++)
                if (Se(n)) {
                    if ((t = n[Ce.expando])) {
                        if (t.events) for (i in t.events) o[i] ? oe.event.remove(n, i) : oe.removeEvent(n, i, t.handle);
                        n[Ce.expando] = void 0;
                    }
    ...
    oe.extend({
        ...
        style: function (e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                (r = typeof n),
                    "string" === r && (o = De.exec(n)) && o[1] && ((n = c(e, t, o)), (r = "number")),
                    null != n &&
                        n === n &&
                        ("number" === r && (n += (o && o[3]) || (oe.cssNumber[s] ? "" : "px")),
        ...
        oe.each(["height", "width"], function (e, t) {
            oe.cssHooks[t] = {
                get: function (e, n, i) {
                    if (n)
                        return Je.test(oe.css(e, "display")) && 0 === e.offsetWidth
                            ? Ge(e, Ke, function () {
                                  return A(e, t, i);
                              })
                            : A(e, t, i);
        ...
        (oe.cssHooks.marginRight = E(ie.reliableMarginRight, function (e, t) {
            if (t) return Ge(e, { display: "inline-block" }, k, [e, "marginRight"]);
        })),
        ...
        oe.extend({
            attr: function (e, t, n) {
                ...
                if (3 !== r && 8 !== r && 2 !== r)
                    return void 0 === e.getAttribute
                        ? oe.prop(e, t, n)
                        : ((1 === r && oe.isXMLDoc(e)) || ((t = t.toLowerCase()), (o = oe.attrHooks[t] || (oe.expr.match.bool.test(t) ? at : void 0))),
                          void 0 !== n
                              ? null === n
            ...
            removeAttr: function (e, t) {
                var n,
                    ...
                    o = 0,
                    r = t && t.match(xe);
                if (r && 1 === e.nodeType) for (; (n = r[o++]); ) (i = oe.propFix[n] || n), oe.expr.match.bool.test(n) && (e[i] = !1), e.removeAttribute(n);
            },
        }),
        (at = {
            set: function (e, t, n) {
    ...
    oe.fn.extend({
        ...
        oe.extend({
            prop: function (e, t, n) {
                ...
                if (3 !== r && 8 !== r && 2 !== r)
                    return (
                        (1 === r && oe.isXMLDoc(e)) || ((t = oe.propFix[t] || t), (o = oe.propHooks[t])),
    ...
    oe.fn.extend({
        ...
        toggleClass: function (e, t) {
            ...
            return "boolean" == typeof t && "string" === n
                ...
                : this.each(function () {
                      var t, i, o, r;
                      if ("string" === n) for (i = 0, o = oe(this), r = e.match(xe) || []; (t = r[i++]); ) o.hasClass(t) ? o.removeClass(t) : o.addClass(t);
        ...
        hasClass: function (e) {
            var t,
                n,
                i = 0;
            for (t = " " + e + " "; (n = this[i++]); ) if (1 === n.nodeType && (" " + q(n) + " ").replace(ut, " ").indexOf(t) > -1) return !0;
            return !1;
        },
    });
    var dt = /\r/g,
            ...
            if (
                ...
                for (r = 0; (a = f[r++]) && !t.isPropagationStopped(); )
                    (t.type = r > 1 ? l : d.bindType || p),
                        (u = (Ce.get(a, "events") || {})[t.type] && Ce.get(a, "handle")),
                        u && u.apply(a, n),
                        (u = c && a[c]) && u.apply && Se(a) && ((t.result = u.apply(a, n)), !1 === t.result && t.preventDefault());
                return (
                    (t.type = p),
                    o ||
                        ...
                        !Se(i) ||
                        (c && oe.isFunction(i[p]) && !oe.isWindow(i) && ((s = i[c]), s && (i[c] = null), (oe.event.triggered = p), i[p](), (oe.event.triggered = void 0), s && (i[c] = s))),
                    t.result
                );
            }
        },
    ...
    (kt.href = ht.href),
            ...
            ajax: function (t, n) {
                function i(t, n, i, s) {
                    ...
                    2 !== w &&
                        ...
                        (x = X(f, x, S, c)),
                        c
                            ? (f.ifModified && ((b = S.getResponseHeader("Last-Modified")), b && (oe.lastModified[r] = b), (b = S.getResponseHeader("etag")) && (oe.etag[r] = b)),
                              204 === t || "HEAD" === f.type ? (C = "nocontent") : 304 === t ? (C = "notmodified") : ((C = x.state), (d = x.data), (y = x.error), (c = !y)))
                            : ((y = C), (!t && C) || ((C = "error"), t < 0 && (t = 0))),
                        (S.status = t),
                        (S.statusText = (n || C) + ""),
                        c ? m.resolveWith(p, [d, C, S]) : m.rejectWith(p, [S, C, y]),
                        S.statusCode(v),
                        (v = void 0),
                        u && h.trigger(c ? "ajaxSuccess" : "ajaxError", [S, f, c ? d : y]),
                        g.fireWith(p, [S, C]),
                        u && (h.trigger("ajaxComplete", [S, f]), --oe.active || oe.event.trigger("ajaxStop")));
                }
                ...
                if (
                    ((m.promise(S).complete = g.add),
                    (S.success = S.done),
                    (S.error = S.fail),
                    (f.url = ((t || f.url || ht.href) + "").replace(vt, "").replace(St, ht.protocol + "//")),
                ...
                (u = oe.event && f.global),
                    ...
                    (r = f.url),
                    f.hasContent || (f.data && ((r = f.url += (gt.test(r) ? "&" : "?") + f.data), delete f.data), !1 === f.cache && (f.url = yt.test(r) ? r.replace(yt, "$1_=" + mt++) : r + (gt.test(r) ? "&" : "?") + "_=" + mt++)),
                    f.ifModified && (oe.lastModified[r] && S.setRequestHeader("If-Modified-Since", oe.lastModified[r]), oe.etag[r] && S.setRequestHeader("If-None-Match", oe.etag[r])),
                    ((f.data && f.hasContent && !1 !== f.contentType) || n.contentType) && S.setRequestHeader("Content-Type", f.contentType),
                    S.setRequestHeader("Accept", f.dataTypes[0] && f.accepts[f.dataTypes[0]] ? f.accepts[f.dataTypes[0]] + ("*" !== f.dataTypes[0] ? ", " + _t + "; q=0.01" : "") : f.accepts["*"]);
                for (d in f.headers) S.setRequestHeader(d, f.headers[d]);
                if (f.beforeSend && (!1 === f.beforeSend.call(p, S, f) || 2 === w)) return S.abort();
                b = "abort";
                for (d in { success: 1, error: 1, complete: 1 }) S[d](f[d]);
                if ((o = F(Tt, f, n, S))) {
        ...
        oe.each(["get", "post"], function (e, t) {
            oe[t] = function (e, n, i, o) {
                return oe.isFunction(n) && ((o = o || i), (i = n), (n = void 0)), oe.ajax(oe.extend({ url: e, type: t, dataType: o, data: n, success: i }, oe.isPlainObject(e) && e));
            };
        }),
                            ...
                            return function () {
                                n &&
                                    ...
                                    "abort" === e
                                        ...
                                        : r(Bt[s.status] || s.status, s.statusText, "text" !== (s.responseType || "text") || "string" != typeof s.responseText ? { binary: s.response } : { text: s.responseText }, s.getAllResponseHeaders()));
                            };
                        }),
                            (s.onload = n()),
                            (i = s.onerror = n("error")),
        ...
        oe.ajaxPrefilter("json jsonp", function (t, n, i) {
            ...
            if (s || "jsonp" === t.dataTypes[0])
                return (
                    ...
                    s ? (t[s] = t[s].replace(Rt, "$1" + o)) : !1 !== t.jsonp && (t.url += (gt.test(t.url) ? "&" : "?") + t.jsonp + "=" + o),
    ...
    (oe.fn.load = function (e, t, n) {
        ...
        var i,
            ...
            s = e.indexOf(" ");
        return (
            s > -1 && ((i = oe.trim(e.slice(s))), (e = e.slice(0, s))),
        ...
        oe.fn.extend({
            offset: function (e) {
                ...
                var t,
                    ...
                    o = { top: 0, left: 0 },
                    r = i && i.ownerDocument;
                if (r) return (t = r.documentElement), oe.contains(t, i) ? ((o = i.getBoundingClientRect()), (n = U(r)), { top: o.top + n.pageYOffset - t.clientTop, left: o.left + n.pageXOffset - t.clientLeft }) : o;
            },
            position: function () {
                if (this[0]) {
                    var e,
                    ...
                    return (
                        ...
                        { top: t.top - i.top - oe.css(n, "marginTop", !0), left: t.left - i.left - oe.css(n, "marginLeft", !0) }
                    );
                }
            },
    ...
    (function (e) {
        ...
        function t(t) {
            ...
            if (
                ...
                "axis" in a && a.axis === a.HORIZONTAL_AXIS && ((d = -1 * f), (f = 0)),
                (c = 0 === f ? d : f),
                "deltaY" in a && ((f = -1 * a.deltaY), (c = f)),
                    ...
                    var t,
                                ...
                                return e(o).each(function () {
                                    ...
                                    if (t.data(i)) {
                                        ...
                                        o.tweenRunning && U(t),
                                            ...
                                            D.call(this),
                                            r.autoDraggerLength && b.call(this),
                                            S.call(this),
                                            k.call(this);
                                        ...
                                        "x" !== r.axis &&
                                            (o.overflowed[0]
                                                ? l[0].height() > l[0].parent().height()
                                                    ? _.call(this)
                                                    : (V(t, c[0].toString(), { dir: "y", dur: 0, overwrite: "none" }), (o.contentReset.y = null))
                                                : (_.call(this), "y" === r.axis ? E.call(this) : "yx" === r.axis && o.overflowed[1] && V(t, c[1].toString(), { dir: "x", dur: 0, overwrite: "none" }))),
                                            "y" !== r.axis &&
                                                (o.overflowed[1]
                                                    ? l[1].width() > l[1].parent().width()
                                                        ? _.call(this)
                                                        : (V(t, c[1].toString(), { dir: "x", dur: 0, overwrite: "none" }), (o.contentReset.x = null))
                                                    : (_.call(this), "x" === r.axis ? E.call(this) : "yx" === r.axis && o.overflowed[0] && V(t, c[0].toString(), { dir: "y", dur: 0, overwrite: "none" }))),
                                            n &&
                                                o &&
                                ...
                                if (void 0 !== t && null != t) {
                                    ...
                                    return e(o).each(function () {
                                        ...
                                        if (o.data(i)) {
                                            ...
                                            (c[0] = z.call(this, c[0], "y")),
                                                (c[1] = z.call(this, c[1], "x")),
                                                l.moveDragger && ((c[0] *= r.scrollRatio.y), (c[1] *= r.scrollRatio.x)),
                                                (l.dur = ie() ? 0 : u),
                                                setTimeout(function () {
                                                    null !== c[0] && void 0 !== c[0] && "x" !== a.axis && r.overflowed[0] && ((l.dir = "y"), (l.overwrite = "all"), V(o, c[0].toString(), l)),
                                                        null !== c[1] && void 0 !== c[1] && "y" !== a.axis && r.overflowed[1] && ((l.dir = "x"), (l.overwrite = "none"), V(o, c[1].toString(), l));
                                                }, l.timeout);
                                        }
                                    });
                                }
                                ...
                                return e(t).each(function () {
                                    ...
                                    if (o.data(i)) {
                                        ...
                                        a.live && h(a.liveSelector || e(t).selector),
                                            ...
                                            o.removeClass(n + " _" + i + "_" + r.idx + " " + u[6] + " " + u[7] + " " + u[5] + " " + u[3]).addClass(u[4]);
                                    }
                                });
                            },
                        },
                        ...
                        v = function () {
                            ...
                            "y" === r.axis || r.advanced.autoExpandHorizontalScroll || m.css("width", y(m)),
                                "outside" === r.scrollbarPosition
                                    ...
                                    : (h.addClass("mCSB_inside").append(c), m.wrap(d)),
                                w.call(this);
                        ...
                        x = function () {
                            ...
                            if (o.advanced.autoExpandHorizontalScroll && "y" !== o.axis) {
                                ...
                                3 === o.advanced.autoExpandHorizontalScroll || (2 !== o.advanced.autoExpandHorizontalScroll && a > r.parent().width())
                                    ? r.css({ width: a, "min-width": "100%", "overflow-x": "inherit" })
                                    : r
                                          .css({ "overflow-x": "inherit", position: "absolute" })
                                          .wrap("<div class='mCSB_h_wrapper' style='position:relative; left:0; width:999999px;' />")
                                          .css({ width: Math.ceil(r[0].getBoundingClientRect().right + 0.4) - Math.floor(r[0].getBoundingClientRect().left), "min-width": "100%", position: "relative" })
                                          .unwrap();
                            }
                        },
                        w = function () {
                            var t = e(this),
                                ...
                                s = [
                                    "<a href='#' class='" + u[13] + "' oncontextmenu='return false;' " + a + " />",
                                    "<a href='#' class='" + u[14] + "' oncontextmenu='return false;' " + a + " />",
                                    "<a href='#' class='" + u[15] + "' oncontextmenu='return false;' " + a + " />",
                                    "<a href='#' class='" + u[16] + "' oncontextmenu='return false;' " + a + " />",
                                ],
                        ...
                        b = function () {
                            var t = e(this),
                                ...
                                d = l && c[3] < c[2] ? c[2] : c[3];
                            a[0]
                                .css({ height: u, "max-height": a[0].parent().height() - 10 })
                                .find(".mCSB_dragger_bar")
                                .css({ "line-height": c[0] + "px" }),
                                a[1].css({ width: d, "max-width": a[1].parent().width() - 10 });
                        },
                        S = function () {
                            var t = e(this),
                                n = t.data(i),
                        ...
                        C = function (e, t, n) {
                            ...
                            "active" === t
                                ? (e.toggleClass(u[0] + " " + i), o.toggleClass(u[1]), (e[0]._draggable = e[0]._draggable ? 0 : 1))
                                : e[0]._draggable || ("hide" === t ? (e.removeClass(u[0]), o.removeClass(u[1])) : (e.addClass(u[0]), o.addClass(u[1])));
                        },
                        T = function () {
                            var t = e(this),
                                n = t.data(i),
                        ...
                        _ = function () {
                            ...
                            if (
                                (U(t),
                                (("x" !== o.axis && !n.overflowed[0]) || ("y" === o.axis && n.overflowed[0])) && (s[0].add(a).css("top", 0), V(t, "_resetY")),
                                ("y" !== o.axis && !n.overflowed[1]) || ("x" === o.axis && n.overflowed[1]))
                            ) {
                                var l = (dx = 0);
                        ...
                        E = function () {
                            var t = e(this),
                                ...
                                s = e(
                                    "#mCSB_" + n.idx + ",#mCSB_" + n.idx + "_container,#mCSB_" + n.idx + "_container_wrapper," + a + " ." + u[12] + ",#mCSB_" + n.idx + "_dragger_vertical,#mCSB_" + n.idx + "_dragger_horizontal," + a + ">a"
                                ),
                        ...
                        D = function (t) {
                            ...
                            "x" !== r.axis &&
                                (o.overflowed[0] && !t
                                    ? (l[0].add(c[0]).add(l[0].children("a")).css("display", "block"), s.removeClass(u[8] + " " + u[10]))
                                    : (r.alwaysShowScrollbar ? (2 !== r.alwaysShowScrollbar && c[0].css("display", "none"), s.removeClass(u[10])) : (l[0].css("display", "none"), s.addClass(u[10])), s.addClass(u[8]))),
                                "y" !== r.axis &&
                                    (o.overflowed[1] && !t
                                        ? (l[1].add(c[1]).add(l[1].children("a")).css("display", "block"), s.removeClass(u[9] + " " + u[11]))
                                        : (r.alwaysShowScrollbar ? (2 !== r.alwaysShowScrollbar && c[1].css("display", "none"), s.removeClass(u[11])) : (l[1].css("display", "none"), s.addClass(u[11])), s.addClass(u[9]))),
                        ...
                        M = function () {
                            ...
                            function n(e, t, n, i) {
                                if (((h[0].idleTimer = d.scrollInertia < 233 ? 250 : 0), o.attr("id") === p[1]))
                                    var r = "x",
                                        a = (o[0].offsetLeft - t + i) * u.scrollRatio.x;
                                else
                                    var r = "y",
                                        a = (o[0].offsetTop - e + n) * u.scrollRatio.y;
                                V(s, a.toString(), { dir: r, drag: !0 });
                            }
                            var o,
                                r,
                                a,
                            ...
                            m
                                .bind("mousedown." + f + " touchstart." + f + " pointerdown." + f + " MSPointerDown." + f, function (n) {
                            ...
                            function o(e) {
                                if (ee(e) && !c && !I(e)[2] && (k.documentTouchScroll || e.preventDefault(), e.stopImmediatePropagation(), (!C || S) && u)) {
                                    ...
                                    var t = D.offset(),
                                        ...
                                        i = I(e)[1] - t.left,
                                        o = "mcsLinearOut";
                                    if ((B.push(n), j.push(i), (N[2] = Math.abs(I(e)[0] - N[0])), (N[3] = Math.abs(I(e)[1] - N[1])), _.overflowed[0]))
                                    ...
                                    a || p ? (q || e.preventDefault(), (S = 1)) : ((C = 1), T.addClass("mCS_touch_action")),
                                        q && e.preventDefault(),
                                        (w = "yx" === k.axis ? [d - n, f - i] : "x" === k.axis ? [null, f - i] : [d - n, null]),
                                        (M[0].idleTimer = 250),
                                        _.overflowed[0] && l(w[0], L, o, "y", "all", !0),
                                        _.overflowed[1] && l(w[1], L, o, "x", O, !0);
                                }
                            }
                            function r(e) {
                                if (!ee(e) || c || I(e)[2]) return void (t = 0);
                            ...
                            f.bind("mousedown." + d, function () {
                                ...
                                .bind("mousemove." + d, function (e) {
                                    if (!t && r && n()) {
                                        ...
                                        a > 0 && a < p.height() && c > 0 && c < p.width()
                                            ? u.step && o("off", null, "stepped")
                                            : ("x" !== l.axis && s.overflowed[0] && (0 > a ? o("on", 38) : a > p.height() && o("on", 40)), "y" !== l.axis && s.overflowed[1] && (0 > c ? o("on", 37) : c > p.width() && o("on", 39)));
                                    }
                                })
                                ...
                                if ((U(n), !O(n, t.target))) {
                                    ...
                                    if ("x" === r.axis || "x" === r.mouseWheel.axis)
                                        var d = "x",
                                            ...
                                            p = "auto" !== r.mouseWheel.scrollAmount ? f[1] : f[0] >= s.width() ? 0.9 * s.width() : f[0],
                                        ...
                                        var d = "y",
                                            ...
                                            p = "auto" !== r.mouseWheel.scrollAmount ? f[1] : f[0] >= s.height() ? 0.9 * s.height() : f[0],
                                    ...
                                    ("y" === d && !o.overflowed[0]) ||
                                        ...
                                        ((v > 0 && 0 !== m) || (0 > v && m !== g) || r.mouseWheel.preventDefault) && (t.stopImmediatePropagation(), t.preventDefault()),
                                        t.deltaFactor < 5 && !r.mouseWheel.normalizeDelta && ((p = t.deltaFactor), (u = 17)),
                                        V(n, (h - v * p).toString(), { dir: d, dur: u }));
                                }
                            }
                            if (e(this).data(i)) {
                                var n = e(this),
                                ...
                                u.length &&
                                    u.each(function () {
                                        e(this).bind("load", function () {
                                            R(this) &&
                                                e(this.contentDocument || this.contentWindow.document).bind("mousewheel." + a, function (e, n) {
                                                    t(e, n);
                                                });
                                        });
                                    }),
                            ...
                            e(".mCSB_" + o.idx + "_scrollbar ." + u[12])
                                ...
                                .bind("click." + r, function (i) {
                                    if (t && ((t = 0), e(i.target).hasClass(u[12]) || e(i.target).hasClass("mCSB_draggerRail"))) {
                                        ...
                                        V(n, f.toString(), { dir: c, scrollEasing: "mcsEaseInOut" });
                                    }
                                });
                        },
                        H = function () {
                            ...
                            a.bind("focusin." + r, function () {
                                ...
                                n.is(o.advanced.autoScrollOnFocus) &&
                                    ...
                                    (t[0]._focusTimeout = setTimeout(function () {
                                        ...
                                        "x" === o.axis || r[0] || V(t, e[0].toString(), { dir: "y", scrollEasing: "mcsEaseInOut", overwrite: l, dur: 0 }),
                                            "y" === o.axis || r[1] || V(t, e[1].toString(), { dir: "x", scrollEasing: "mcsEaseInOut", overwrite: l, dur: 0 });
                                    }, t[0]._focusTimer)));
                            });
                        },
                        P = function () {
                        ...
                        W = function () {
                                    ...
                                    case "keyup":
                                        ...
                                        if (("x" !== r.axis && (38 === s || 40 === s)) || ("y" !== r.axis && (37 === s || 39 === s))) {
                                            ...
                                            if (((o.overflowed[0] || o.overflowed[1]) && (t.preventDefault(), t.stopImmediatePropagation()), "keyup" === t.type)) {
                                                ...
                                                V(n, h.toString(), { dir: p, scrollEasing: "mcsEaseInOut" });
                                            }
                            ...
                            f.length &&
                                f.each(function () {
                                    e(this).bind("load", function () {
                                        R(this) &&
                                            e(this.contentDocument || this.contentWindow.document).bind(p[0], function (e) {
                                                t(e);
                                            });
                                    });
                                }),
                        ...
                        F = function (t, n, o, r, a) {
                            function s(e) {
                                ...
                                var n = "stepped" !== d.type,
                                    ...
                                    w = !!e;
                                return (
                                    e && 17 > i && (y = "x" === d.dir[0] ? u[1] : u[0]),
                                    V(t, y.toString(), { dir: d.dir[0], scrollEasing: x, dur: i, onComplete: w }),
                                    e
                                        ? void (d.dir = !1)
                                        : (clearTimeout(d.step),
                                    ...
                                    0 === s.parents("html").length
                                        ...
                                        : void (f[0].autoUpdate = setTimeout(function () {
                                              return c.advanced.updateOnSelectorChange && ((l.poll.change.n = r()), l.poll.change.n !== l.poll.change.o)
                                                  ? ((l.poll.change.o = l.poll.change.n), void a(3))
                                                  : c.advanced.updateOnContentResize && ((l.poll.size.n = s[0].scrollHeight + s[0].scrollWidth + f[0].offsetHeight + s[0].offsetHeight + s[0].offsetWidth), l.poll.size.n !== l.poll.size.o)
                                                  ? ((l.poll.size.o = l.poll.size.n), void a(1))
                                                  : !c.advanced.updateOnImageLoad || ("auto" === c.advanced.updateOnImageLoad && "y" === c.axis) || ((l.poll.img.n = f.find("img").length), l.poll.img.n === l.poll.img.o)
                        ...
                        V = function (t, n, o) {
                            ...
                            var l = t.data(i),
                                c = l.opt,
                                u = { trigger: "internal", dir: "y", scrollEasing: "mcsEaseOut", drag: !1, dur: c.scrollInertia, overwrite: "all", callbacks: !0, onStart: !0, onUpdate: !0, onComplete: !0 },
                                o = e.extend(u, o),
                            ...
                            if (
                                ...
                                S[1] < 0 || (0 === S[0] && 0 === S[1]) ? (S = [0, 0]) : S[1] >= b[1] ? (S = [b[0], b[1]]) : (S[0] = -S[0]),
                                    t[0].mcs || (s(), r("onInit") && c.callbacks.onInit.call(t[0])),
                                    clearTimeout(p[0].onCompleteTimeout),
                                    G(y[0], x, Math.round(S[1]), d[1], o.scrollEasing),
                                    (!l.tweenRunning && ((0 === w && S[0] >= 0) || (w === b[0] && S[0] <= b[0]))) ||
                                        G(p[0], x, Math.round(S[0]), d[0], o.scrollEasing, o.overwrite, {
                                            onStart: function () {
                                            ...
                                            onComplete: function () {
                                                if (o.callbacks && o.onComplete) {
                                                    ...
                                                    p[0].onCompleteTimeout = setTimeout(function () {
                                                        r("onScroll") && (s(), c.callbacks.onScroll.call(t[0])),
                                                            r("onTotalScroll") && S[1] >= b[1] - k && l.cbOffsets[0] && (s(), c.callbacks.onTotalScroll.call(t[0])),
                                                            r("onTotalScrollBack") && S[1] <= E && l.cbOffsets[1] && (s(), c.callbacks.onTotalScrollBack.call(t[0])),
                                                            (l.tweenRunning = !1),
                                                            (p[0].idleTimer = 0),
                                                            C(y, "hide");
                                                    }, e);
                            ...
                            function c(e, t, n, i, o) {
                                switch (o) {
                                    ...
                                    default:
                                        var r = (e /= i) * e,
                                            a = r * e;
                                        return t + n * (0.499999999999997 * a * r + -2.5 * r * r + 5.5 * a + -6.5 * r + 4 * e);
                                }
                            }
                                        ...
                                        function (t) {
                                            ...
                                            if (r.length)
                                                return (
                                                    ...
                                                    i[0] + ne(o)[0] >= 0 && i[0] + ne(o)[0] < n.height() - o.outerHeight(!1) && i[1] + ne(o)[1] >= 0 && i[1] + ne(o)[1] < n.width() - o.outerWidth(!1)
                                                );
                                        },
                                    mcsInSight:
                                        e.expr[":"].mcsInSight ||
                                        function (t) {
                                            ...
                                            if (s.length)
                                                return (
                                                    ...
                                                    (o = [s[0].offsetTop + ne(a)[0], s[0].offsetLeft + ne(a)[1]]),
                                                    (i = [s.parent()[0].offsetHeight, s.parent()[0].offsetWidth]),
                                                    (r = [n[0] < i[0] ? [0.9, 0.1] : [0.6, 0.4], n[1] < i[1] ? [0.9, 0.1] : [0.6, 0.4]]),
                                                    o[0] - i[0] * r[0][0] < 0 && o[0] + n[0] - i[0] * r[0][1] >= 0 && o[1] - i[1] * r[1][0] < 0 && o[1] + n[1] - i[1] * r[1][1] >= 0
                                                );
                                        },
                                    mcsOverflow:
                                        e.expr[":"].mcsOverflow ||
    ...
    Yahia = {
        load: function (e) {
            ...
            "home" == e
                ...
                : "bucket" == e
                ? (t = "includes/images/yahiarefaiea-bucket.png")
                : "projectsAll" == e
                ? (t = "includes/images/yahiarefaiea-projects.png")
                : "thoughtsAll" == e
                ? (t = "includes/images/yahiarefaiea-thoughts.png")
                : "notFound" == e && (t = "includes/images/yahiarefaiea-notFound.png");
                ...
                setTimeout(function () {
                    Identity.stop(function () {
                        Router.updateWrapper(),
                            ...
                            md.mobile() || Yahia.load(Router.wrapper[0]),
...
(Router.routes = function (e) {
    ...
    void 0 === t[0]
        ? Router.push("home")
        : "secret" == t[0] && void 0 === t[1]
        ? Router.push("secret")
        : "bucket" == t[0] && void 0 === t[1]
        ? Router.push("bucket")
        : "bucket" == t[0] && "all" == t[1] && void 0 === t[2]
        ? Router.push("bucketAll")
        : "projects" == t[0] && void 0 === t[1]
        ? Router.push("projectsAll")
        : "thoughts" == t[0] && void 0 === t[1]
...
$(document).ready(function () {
    Identity.work(),
        $(".template main").mCustomScrollbar({ theme: "dark" }),
